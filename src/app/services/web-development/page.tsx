...
export const metadata: Metadata = {
  title: "Website Development | FALAH BRANDHOUSE",
  description: "We design and develop professional digital homes focused on user experience and lead conversion.",
};
...
const whatWeDo = [
        { title: "BUSINESS WEBSITES", desc: "Professional digital homes for businesses, built on modern scalable stacks." },
      { title: "LANDING PAGES", desc: "Focused single-page experiences for campaigns and specific lead generation." },
      { title: "CORPORATE PLATFORMS", desc: "Structured digital experiences for established companies with multiple offerings." },
      { title: "CUSTOM EXPERIENCES", desc: "Advanced web applications and interactive platforms where required." }
];

const deliverables = [
        "Custom UI/UX Design (Figma)",
      "Fully Responsive Developed Website",
...
const process = [
        { title: "DISCOVER", desc: "We understand your goals, users, and content requirements." },
      { title: "PLAN", desc: "We map out the architecture, wireframes, and user journeys." },
      { title: "DESIGN", desc: "We create the high-fidelity user interface and visual design." },
      { title: "BUILD", desc: "We engineer the website using modern frameworks." },
      { title: "LAUNCH", desc: "We test, deploy, and ensure everything runs perfectly." }
];
...
const faqs = [
        { q: "Can you redesign an existing website?", a: "Yes. We audit your current site, retain what works (like SEO equity), and completely overhaul the design and technical foundation." },
      { q: "What technology do you use?", a: "We primarily build custom solutions using Next.js and React for high performance, but we also work with Webflow and Shopify depending on your business needs." },
      { q: "Do you write the website copy?", a: "We provide structural copywriting guidance. If you need full professional copywriting, we include that in the project scope." },
      { q: "Is SEO included?", a: "All our websites include foundational technical SEO. For ongoing ranking growth, we offer a dedicated SEO service." },
      { q: "Do you provide hosting and maintenance?", a: "Yes, we offer ongoing support, hosting management, and technical maintenance packages post-launch." }
];

const flowNodes = [
        "EXPERIENCE", "TRUST", "ACTION", "CONVERSION"
];
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-[5vw]">
          ...
          <div className="mb-20 md:mb-32 max-w-5xl">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-slate font-primary leading-relaxed font-medium mb-10 md:mb-12 max-w-3xl">
              We design and develop professional digital homes focused on user experience and lead conversion.
            </p>
            <Link 
              href="/contact"
