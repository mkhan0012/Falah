...
export const metadata: Metadata = {
  ...
  description: "Data-driven marketing strategies to scale your digital presence and generate measurable business outcomes.",
};

const capabilities = [
        { title: "Performance Marketing", desc: "Targeted paid campaigns across Search and Social engineered for maximum ROAS." },
      { title: "Lead Generation", desc: "Designing complete funnel architectures to capture, nurture, and convert prospects." },
      { title: "Data Analytics", desc: "Implementing robust tracking to understand exactly where growth is coming from." },
      { title: "Lifecycle Marketing", desc: "Email and retention strategies that maximize the lifetime value of every customer." }
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-warm-grey pt-12">
              <div className="md:col-span-8 lg:col-span-6">
                <p className="text-2xl md:text-3xl text-slate font-primary leading-relaxed font-medium">
                  Data-driven marketing strategies to scale your digital presence and generate measurable business outcomes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-warm-grey pt-24 mb-32 grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-8">
              <p className="text-3xl md:text-4xl text-graphite leading-tight font-primary font-medium max-w-4xl">
                Growth cannot be left to chance. Our digital marketing systems are built on measurable metrics, rigorous testing, and strategies that connect your premium brand directly with revenue generation.
              </p>
            </div>
          </div>

          <div className="border-t border-warm-grey pt-24 mb-32">
            <ServiceCapabilities capabilities={capabilities} visualizerType="growth" />
          </div>
