...
export const metadata: Metadata = {
  ...
  description: "We build authority and engagement through strategic social content and distribution.",
};

const situations = [
        "Are creating content but seeing no engagement",
      "Lack a consistent visual style on social channels",
      "Do not have time to manage their own social presence",
      "Want to build thought leadership on LinkedIn",
      "Need high-quality visual content for Instagram/LinkedIn"
];

const whatWeDo = [
        { title: "SOCIAL STRATEGY", desc: "Defining content pillars, audience targeting, and posting cadence." },
      { title: "VISUAL CONTENT", desc: "Designing premium static graphics, carousels, and templates." },
      { title: "COPYWRITING", desc: "Writing engaging, authoritative captions tailored to each platform." },
      { title: "COMMUNITY", desc: "Managing engagement, responding to comments, and building relationships." }
];

const deliverables = [
        "Social Media Strategy Document",
      "Content Calendar (Monthly)",
      "Custom Designed Social Assets",
      "Analytics and Performance Reports",
      "Hashtag and Keyword Strategy"
];

const process = [
        { title: "AUDIT", desc: "We review your current presence and competitors." },
      { title: "STRATEGY", desc: "We establish content pillars and visual direction." },
      { title: "CREATE", desc: "We design and write a month's worth of content." },
      { title: "PUBLISH", desc: "We handle scheduling and distribution." },
      { title: "MEASURE", desc: "We analyze engagement and adjust the strategy." }
];

const measure = [
        "Follower growth and profile visits",
      "Engagement rate (Likes, comments, shares)",
      "Inbound inquiries from social channels"
];

const faqs = [
        { q: "Which platforms do you manage?", a: "We focus primarily on LinkedIn for B2B and professional services, and Instagram for highly visual and consumer-facing brands." },
      { q: "Do you shoot photography/video?", a: "We provide creative direction. If custom production is needed, we partner with specialized production teams or use premium curated assets." },
      { q: "Can I review content before it goes live?", a: "Yes, we provide a content calendar for your approval before anything is published." }
];

const flowNodes = [
        "CONTENT", "DISTRIBUTION", "COMMUNITY", "AUTHORITY"
];
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-[5vw]">
          ...
          <div className="mb-20 md:mb-32 max-w-5xl">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-slate font-primary leading-relaxed font-medium mb-10 md:mb-12 max-w-3xl">
              We build authority and engagement through strategic social content and distribution.
            </p>
            <Link 
              href="/contact"
