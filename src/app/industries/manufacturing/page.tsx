...
export const metadata: Metadata = {
  ...
  description: "Transforming industrial businesses into modern digital leaders.",
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-warm-grey pt-12">
              <div className="md:col-span-8 lg:col-span-6">
                <p className="text-2xl md:text-3xl text-slate font-primary leading-relaxed font-medium">
                  Transforming industrial businesses into modern digital leaders.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 border-t border-warm-grey pt-24 mb-32">
            <div>
              ...
              <p className="text-lg text-slate leading-relaxed font-primary">
                In the Manufacturing sector, digital presence is how you establish trust before a conversation even begins. We build strategic websites, localized SEO, and brand systems that position you as the premium choice in your market.
              </p>
            </div>
            <div>
